...
function Rainbow() {
    return (
        <div className="container demo-container">
            ...
            <h5 class="teal orange-text text-lighten-4">Experience is simply the name we give our mistakes</h5>
            <h5 class="deep-orange accent-3 purple-text text-darken-2">Always forgive your enemies - nothing annoys them so much</h5>
        </div>
    )
}
